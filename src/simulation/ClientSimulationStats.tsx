...
export const ClientSimulationStats = ({ 
    ...
    useEffect(() => {
        if (!frameCountContainerRef.current || !downloadContainerRef.current) return;

        const xValues = Array(60).fill(0).map((_, i) => i);
        ...
        const frameCountPlot = new uPlot({
            ...
            padding: [10, 0, 10, 0],
        }, [xValues, dataRef.current.predictedFrameCount], frameCountContainerRef.current);
        ...
        const downloadPlot = new uPlot({
            ...
            padding: [10, 0, 10, 0],
        }, [xValues, dataRef.current.downloadKbps, dataRef.current.uploadKbps], downloadContainerRef.current);
    ...
    return (
        <div style={{ width: "100%" }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <div ref={frameCountContainerRef} style={{ height: '100px', flex: 1 }} />
